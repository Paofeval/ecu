...
Regions are the key spatial units of the Ocean Health Index: scores are calculated for each region and combined (with an area-weighted average) to produce scores for the entire study area (in this case, {{ site.study_area }}).
